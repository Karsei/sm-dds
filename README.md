...
Dedicated 서버 내에 가상의 재화와 상점를 도입하여 이용자들이 재화를 가지고 상점 메뉴를 통해 아이템을 구매할 수 있도록 도와줍니다. 아이템들은 Source 엔진의 여러 리소스를 다양하게 활용할 수 있도록 제작되었으며 또한, 해당 플러그인이 제공하는 API 를 이용함으로서 다른 플러그인에서도 각 시즌이나 상황에 맞게 유연하게 활용하여 사용할 수 있도록 하였습니다.
