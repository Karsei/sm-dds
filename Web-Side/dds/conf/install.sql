...
INSERT INTO `dds_item_list` (`ilidx`, `gloname`, `icidx`, `money`, `havtime`, `env`, `status`) VALUES (NULL, 'en:Developer||ko:Developer', '6', '100', '0', 'ENV_DDS_SYS_GAME:all||ENV_DDS_INFO_ADRS:||ENV_DDS_INFO_POS:0 0 0||ENV_DDS_INFO_ANG:0 0 0||ENV_DDS_INFO_COLOR:255 255 255 255||ENV_DDS_INFO_TAGSTR:Developer||ENV_DDS_INFO_FREETAG:0||ENV_DDS_LIMIT_BUY_CLASS:all||ENV_DDS_LIMIT_USE_CLASS:all||ENV_DDS_LIMIT_SHOW_LIST_CLASS:all||ENV_DDS_USE_TEAM:all', '1');
INSERT INTO `dds_item_list` (`ilidx`, `gloname`, `icidx`, `money`, `havtime`, `env`, `status`) VALUES (NULL, 'en:Disposable Free Tag||ko:일회용 자유 태그', '6', '100', '-1', 'ENV_DDS_SYS_GAME:all||ENV_DDS_INFO_ADRS:||ENV_DDS_INFO_POS:0 0 0||ENV_DDS_INFO_ANG:0 0 0||ENV_DDS_INFO_COLOR:255 255 255 255||ENV_DDS_INFO_TAGSTR:||ENV_DDS_INFO_FREETAG:1||ENV_DDS_LIMIT_BUY_CLASS:all||ENV_DDS_LIMIT_USE_CLASS:all||ENV_DDS_LIMIT_SHOW_LIST_CLASS:all||ENV_DDS_USE_TEAM:all', '1');
