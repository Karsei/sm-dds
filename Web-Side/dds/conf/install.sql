...
INSERT INTO `dds_item_category` (`icidx`, `gloname`, `orderidx`, `env`, `status`) VALUES (NULL, 'en:Laser Bullet||ko:레이저 총알', '4', 'ENV_DDS_SYS_GAME:all||ENV_DDS_LIMIT_BUY_CLASS:all||ENV_DDS_LIMIT_USE_CLASS:all||ENV_DDS_LIMIT_SHOW_LIST_CLASS:all||ENV_DDS_USE_TEAM:2,3', '1');
INSERT INTO `dds_item_category` (`icidx`, `gloname`, `orderidx`, `env`, `status`) VALUES (NULL, 'en:Effect Shoes||ko:이펙트 슈즈', '5', 'ENV_DDS_SYS_GAME:all||ENV_DDS_LIMIT_BUY_CLASS:all||ENV_DDS_LIMIT_USE_CLASS:all||ENV_DDS_LIMIT_SHOW_LIST_CLASS:all||ENV_DDS_USE_TEAM:2,3', '1');
INSERT INTO `dds_item_category` (`icidx`, `gloname`, `orderidx`, `env`, `status`) VALUES (NULL, 'en:Chat Tag||ko:채팅 태그', '6', 'ENV_DDS_SYS_GAME:all||ENV_DDS_LIMIT_BUY_CLASS:all||ENV_DDS_LIMIT_USE_CLASS:all||ENV_DDS_LIMIT_SHOW_LIST_CLASS:all||ENV_DDS_USE_TEAM:all', '1');
INSERT INTO `dds_item_category` (`icidx`, `gloname`, `orderidx`, `env`, `status`) VALUES (NULL, 'en:Bubbles||ko:버블', '7', 'ENV_DDS_SYS_GAME:all||ENV_DDS_LIMIT_BUY_CLASS:all||ENV_DDS_LIMIT_USE_CLASS:all||ENV_DDS_LIMIT_SHOW_LIST_CLASS:all||ENV_DDS_USE_TEAM:2,3', '1');
INSERT INTO `dds_item_category` (`icidx`, `gloname`, `orderidx`, `env`, `status`) VALUES (NULL, 'en:Light||ko:조명', '8', 'ENV_DDS_SYS_GAME:all||ENV_DDS_LIMIT_BUY_CLASS:all||ENV_DDS_LIMIT_USE_CLASS:all||ENV_DDS_LIMIT_SHOW_LIST_CLASS:all||ENV_DDS_USE_TEAM:2,3', '1');
INSERT INTO `dds_item_category` (`icidx`, `gloname`, `orderidx`, `env`, `status`) VALUES (NULL, 'en:Flash||ko:플래시', '9', 'ENV_DDS_SYS_GAME:all||ENV_DDS_LIMIT_BUY_CLASS:all||ENV_DDS_LIMIT_USE_CLASS:all||ENV_DDS_LIMIT_SHOW_LIST_CLASS:all||ENV_DDS_USE_TEAM:2,3', '1');
INSERT INTO `dds_item_category` (`icidx`, `gloname`, `orderidx`, `env`, `status`) VALUES (NULL, 'en:Laser Point||ko:레이저 포인트', '10', 'ENV_DDS_SYS_GAME:all||ENV_DDS_LIMIT_BUY_CLASS:all||ENV_DDS_LIMIT_USE_CLASS:all||ENV_DDS_LIMIT_SHOW_LIST_CLASS:all||ENV_DDS_USE_TEAM:2,3', '1');
INSERT INTO `dds_item_category` (`icidx`, `gloname`, `orderidx`, `env`, `status`) VALUES (NULL, 'en:Particle||ko:파티클', '11', 'ENV_DDS_SYS_GAME:all||ENV_DDS_LIMIT_BUY_CLASS:all||ENV_DDS_LIMIT_USE_CLASS:all||ENV_DDS_LIMIT_SHOW_LIST_CLASS:all||ENV_DDS_USE_TEAM:2,3', '1');
INSERT INTO `dds_item_category` (`icidx`, `gloname`, `orderidx`, `env`, `status`) VALUES (NULL, 'en:Title||ko:타이틀', '12', 'ENV_DDS_SYS_GAME:all||ENV_DDS_LIMIT_BUY_CLASS:all||ENV_DDS_LIMIT_USE_CLASS:all||ENV_DDS_LIMIT_SHOW_LIST_CLASS:all||ENV_DDS_USE_TEAM:2,3', '1');
